...
public class ArmoredGroundEnemy extends GroundEnemy {
    ...
    public ArmoredGroundEnemy(BattleScreen parent, EnemyConfig enemyConfig, PathStep pathStep) {
    ...
    public static class ArmoredGroundEnemyBuilder extends GroundEnemyBuilder {
        public ArmoredGroundEnemyBuilder(BattleScreen game, EnemyConfig enemyConfig, Node startingNode) {
